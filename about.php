<div class="container mx-auto px-4 mt-10 text-gray-300">
    <div class="max-w-3xl mx-auto">
        ...
        <p class="text-lg leading-relaxed">
            I spent well over a decade working actively in the underground art and music scene in my hometown of Cincinnati, 
            participating in as well as curating numerous exhibitions and events, utilizing my full range of creative skills 
            from painting and sculpture to installation and set design, to performance and music.
        </p>
    </div>
</div>
